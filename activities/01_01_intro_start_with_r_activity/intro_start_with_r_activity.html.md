...
order: 1
week: 1
title: "Introduction — Start with R"
description: "Hands-on activity: getting started in R and RStudio."
---
...
::: {.cell-output-display}
![](intro_start_with_r_activity_files/figure-html/unnamed-chunk-5-1.png){width=336}
:::
:::
...
::: {.cell-output-display}
![](intro_start_with_r_activity_files/figure-html/unnamed-chunk-6-1.png){width=336}
:::
:::
...
::: {.cell-output-display}
![](intro_start_with_r_activity_files/figure-html/unnamed-chunk-7-1.png){width=336}
:::
...
::: {.cell-output-display}
![](intro_start_with_r_activity_files/figure-html/unnamed-chunk-8-1.png){width=336}
:::
:::
...
::: {.cell-output-display}
![](intro_start_with_r_activity_files/figure-html/unnamed-chunk-9-1.png){width=336}
:::
:::
...
::: {.cell-output-display}
![](intro_start_with_r_activity_files/figure-html/unnamed-chunk-10-1.png){width=336}
:::
:::
...
::: {.cell-output-display}
![](intro_start_with_r_activity_files/figure-html/unnamed-chunk-11-1.png){width=336}
:::
:::
