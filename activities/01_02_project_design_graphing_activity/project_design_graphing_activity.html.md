...
description: "Hands-on activity: project setup and graphing with ggplot2."
author: "Bill Perry"
metadata-files:
...
::: {.cell-output-display}
![](project_design_graphing_activity_files/figure-html/basic-histogram-1.png){width=336}
:::
:::
...
::: {.cell-output-display}
![](project_design_graphing_activity_files/figure-html/unnamed-chunk-4-1.png){width=336}
:::
:::
...
::: {.cell-output-display}
![](project_design_graphing_activity_files/figure-html/multiple-plot-types-1.png){width=336}
:::
:::
...
::: {.cell-output-display}
![](project_design_graphing_activity_files/figure-html/layered-plot-1.png){width=768}
:::
:::
...
::: {.cell-output-display}
![](project_design_graphing_activity_files/figure-html/unnamed-chunk-5-1.png){width=336}
:::
:::
...
::: {.cell-output-display}
![](project_design_graphing_activity_files/figure-html/publication-plot-1.png){width=768}
:::
:::
...
::: {.cell-output-display}
![](project_design_graphing_activity_files/figure-html/multi-panel-1.png){width=960}
:::
:::
