...
::: {.cell-output-display}
![](descriptive_stats_wrangling_activity_files/figure-html/histograms-1.png){width=336}
:::
:::
...
::: {.cell-output-display}
![](descriptive_stats_wrangling_activity_files/figure-html/unnamed-chunk-1-1.png){width=336}
:::
:::
...
::: {.cell-output-display}
![](descriptive_stats_wrangling_activity_files/figure-html/boxplots-1.png){width=336}
:::
:::
...
::: {.cell-output-display}
![](descriptive_stats_wrangling_activity_files/figure-html/density-plots-1.png){width=336}
:::
:::
