...
description: "Hands-on activity: probability and statistical inference."
author: "Bill Perry"
metadata-files:
...
::: {.cell-output-display}
![](probability_inference_activity_files/figure-html/unnamed-chunk-3-1.png){width=336}
:::
:::
...
::: {.cell-output-display}
![](probability_inference_activity_files/figure-html/unnamed-chunk-5-1.png){width=336}
:::
:::
...
::: {.cell-output-display}
![](probability_inference_activity_files/figure-html/unnamed-chunk-6-1.png){width=336}
:::
:::
...
::: {.cell-output-display}
![](probability_inference_activity_files/figure-html/unnamed-chunk-7-1.png){width=336}
:::
:::
...
::: {.cell-output-display}
![](probability_inference_activity_files/figure-html/unnamed-chunk-8-1.png){width=336}
:::
:::
...
::: {.cell-output-display}
![](probability_inference_activity_files/figure-html/unnamed-chunk-9-1.png){width=336}
:::
:::
...
::: {.cell-output-display}
![](probability_inference_activity_files/figure-html/unnamed-chunk-10-1.png){width=336}
:::
:::
...
::: {.cell-output-display}
![](probability_inference_activity_files/figure-html/unnamed-chunk-12-1.png){width=336}
:::
:::
