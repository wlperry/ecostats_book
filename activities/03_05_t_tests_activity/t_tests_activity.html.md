...
description: "Hands-on activity: running t-tests in R."
author: "Bill Perry"
metadata-files:
...
::: {.cell-output-display}
![](t_tests_activity_files/figure-html/boxplot-1.png){width=336}
:::
:::
...
::: {.cell-output-display}
![](t_tests_activity_files/figure-html/spaghetti-1.png){width=336}
:::
:::
...
::: {.cell-output-display}
![](t_tests_activity_files/figure-html/qq_all-1.png){width=336}
:::
...
::: {.cell-output-display}
![](t_tests_activity_files/figure-html/unnamed-chunk-1-1.png){width=336}
:::
...
::: {.cell-output-display}
![](t_tests_activity_files/figure-html/ggplot_qqplot_combined-1.png){width=336}
:::
:::
...
::: {.cell-output-display}
![](t_tests_activity_files/figure-html/unnamed-chunk-5-1.png){width=336}
:::
:::
...
::: {.cell-output-display}
![](t_tests_activity_files/figure-html/unnamed-chunk-6-1.png){width=336}
:::
:::
...
::: {.cell-output-display}
![](t_tests_activity_files/figure-html/unnamed-chunk-7-1.png){width=336}
:::
:::
...
::: {.cell-output-display}
![](t_tests_activity_files/figure-html/unnamed-chunk-8-1.png){width=336}
:::
:::
...
::: {.cell-output-display}
![](t_tests_activity_files/figure-html/unnamed-chunk-11-1.png){width=336}
:::
:::
