...
description: "Hands-on activity: power and error rates."
author: "Bill Perry"
metadata-files:
...
::: {.cell-output-display}
![](power_and_error_activity_files/figure-html/visualize-1.png){width=336}
:::
...
::: {.cell-output-display}
![](power_and_error_activity_files/figure-html/unnamed-chunk-3-1.png){width=336}
:::
:::
...
::: {.cell-output-display}
![](power_and_error_activity_files/figure-html/unnamed-chunk-5-1.png){width=336}
:::
:::
...
::: {.cell-output-display}
![](power_and_error_activity_files/figure-html/unnamed-chunk-6-1.png){width=336}
:::
:::
