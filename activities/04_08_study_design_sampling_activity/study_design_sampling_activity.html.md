...
order: 8
week: 4
title: "Study Design & Sampling"
description: "Hands-on activity: experimental design and sampling."
author: "Bill Perry"
metadata-files:
...
::: {.cell-output-display}
![](study_design_sampling_activity_files/figure-html/basic_plot-1.png){width=336}
:::
:::
...
::: {.cell-output-display}
![](study_design_sampling_activity_files/figure-html/stream_plot-1.png){width=336}
:::
:::
...
::: {.cell-output-display}
![](study_design_sampling_activity_files/figure-html/power_curve-1.png){width=336}
:::
:::
