...
::: {.cell-output-display}
![](multiple_regression_activity_files/figure-docx/visual_corr-1.jpeg)
:::
:::
...
::: {.cell-output-display}
![](multiple_regression_activity_files/figure-docx/pairs-plot-1.jpeg)
:::
:::
...
::: {.cell-output-display}
![](multiple_regression_activity_files/figure-docx/unnamed-chunk-1-1.jpeg)
:::
:::
...
::: {.cell-output-display}
![](multiple_regression_activity_files/figure-docx/partial-plots-1.jpeg)
:::
...
::: {.cell-output-display}
![](multiple_regression_activity_files/figure-docx/unnamed-chunk-3-1.jpeg)
:::
...
::: {.cell-output-display}
![](multiple_regression_activity_files/figure-docx/diagnostics-1.jpeg)
:::

::: {.cell-output-display}
![](multiple_regression_activity_files/figure-docx/diagnostics-2.jpeg)
:::

::: {.cell-output-display}
![](multiple_regression_activity_files/figure-docx/diagnostics-3.jpeg)
:::

::: {.cell-output-display}
![](multiple_regression_activity_files/figure-docx/diagnostics-4.jpeg)
:::
...
::: {.cell-output-display}
![](multiple_regression_activity_files/figure-docx/unnamed-chunk-4-1.jpeg)
:::
:::
...
::: {.cell-output-display}
![](multiple_regression_activity_files/figure-docx/unnamed-chunk-5-1.jpeg)
:::

::: {.cell-output-display}
![](multiple_regression_activity_files/figure-docx/unnamed-chunk-5-2.jpeg)
:::

::: {.cell-output-display}
![](multiple_regression_activity_files/figure-docx/unnamed-chunk-5-3.jpeg)
:::

::: {.cell-output-display}
![](multiple_regression_activity_files/figure-docx/unnamed-chunk-5-4.jpeg)
:::
