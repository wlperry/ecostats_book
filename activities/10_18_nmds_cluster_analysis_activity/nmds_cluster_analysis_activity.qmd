...
order: 18
week: 10
title: "NMDS & PERMANOVA"
description: "Hands-on activity: NMDS ordination and PERMANOVA."
author: "Bill Perry"
format:
  html: default
  docx: default
...
library(vegan)        # For NMDS, PERMANOVA, and other multivariate analyses
...
**Interpretation**: - Stress value: `r round(iris_nmds_model$stress, 3)` - This is `r ifelse(iris_nmds_model$stress < 0.1, "excellent", ifelse(iris_nmds_model$stress < 0.2, "good", "poor"))` representation
...
**Interpretation**: - F-statistic: `r round(iris_permanova_model$F[1], 2)` - R² (variance explained): `r round(iris_permanova_model$R2[1], 3)` - p-value: `r iris_permanova_model$"Pr(>F)"[1]`
...
**Interpretation**: - R statistic: `r round(iris_anosim_model$statistic, 3)` - p-value: `r iris_anosim_model$signif` - R close to 1 indicates strong separation between groups
