...
```{r}
#| message: true # no messages - may want on initially
#| warning: true # no warnings - may want on initially - can set above
#| include: true # shows nothing and runs code
#| paged-print: false # no multiple windows in output
